...
# Build Targets
.build-conf: ${BUILD_SUBPROJECTS} ../great_game/dist/Release/GNU-MacOSX/libcpp_plugin.dylib

../great_game/dist/Release/GNU-MacOSX/libcpp_plugin.dylib: ${OBJECTFILES}
	${MKDIR} -p ../great_game/dist/Release/GNU-MacOSX
	${LINK.cc} -dynamiclib -install_name libcpp_plugin.dylib -o ../great_game/dist/Release/GNU-MacOSX/libcpp_plugin.dylib -fPIC ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf:
	${RM} -r build/Release
	${RM} ../great_game/dist/Release/GNU-MacOSX/libcpp_plugin.dylib
