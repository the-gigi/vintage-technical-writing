...
# Build Targets
.build-conf: ${BUILD_SUBPROJECTS} ../great_game/dist/Debug/GNU-Linux-x86/libcpp_plugin.so

../great_game/dist/Debug/GNU-Linux-x86/libcpp_plugin.so: ${OBJECTFILES}
	${MKDIR} -p ../great_game/dist/Debug/GNU-Linux-x86
	${LINK.cc} -shared -o ../great_game/dist/Debug/GNU-Linux-x86/libcpp_plugin.so -fPIC ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf:
	${RM} -r build/Debug
	${RM} ../great_game/dist/Debug/GNU-Linux-x86/libcpp_plugin.so
